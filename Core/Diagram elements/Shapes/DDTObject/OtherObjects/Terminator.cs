...
{
    public class Terminator : SmallObject
	{
		#region Fields
		...
		public Terminator(IModel s) : base(s)
		{
            //Init();
		}
        ...
        public Terminator(string text, bool shrink)
            : base(text, shrink)
        {
            //Init();
        }
		...
		public override void Paint(System.Drawing.Graphics g)
		{
            ...
            Brush TShapeBrush = Brushes.WhiteSmoke;
            g.FillEllipse(TShapeBrush, Rectangle);
			
            //the edge of the bundle
            Pen TPen = new Pen(Color.Red, 3F);
            TPen.DashStyle = System.Drawing.Drawing2D.DashStyle.Dash;
            if (Hovered || IsSelected)
            {
                TPen.Color = Color.Red;
                TPen.Width = 5F;
                g.DrawEllipse(TPen, Rectangle);
