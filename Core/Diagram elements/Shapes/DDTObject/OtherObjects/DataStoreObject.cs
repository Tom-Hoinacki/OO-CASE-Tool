...
{
    public class DataStoreObject : SmallObject
	{
		#region Fields
		...
		public DataStoreObject(IModel s) : base(s)
		{
            //Init();
		}
        public DataStoreObject(string text)
            : base(text)
        {
            //Init();
        }

        public DataStoreObject(string text, bool shrink)
            : base(text, shrink)
        {
            //Init();
        }
		...
		public override void Paint(System.Drawing.Graphics g)
		{
            ...
            Brush DSShapeBrush = Brushes.LightGoldenrodYellow;
            g.FillRectangle(DSShapeBrush, Rectangle); 

            //the edge of the bundle
            Pen DSPen = new Pen(Color.Brown, 2F);

            DSPen.DashStyle = System.Drawing.Drawing2D.DashStyle.DashDotDot;
